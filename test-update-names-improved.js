// Quick test script to invoke improved update-account-names function
...
async function testImprovedUpdateNames() {
  console.log('🚀 Invoking improved update-account-names function...')
